...
<html>
  ...
  <body>
		...
		<h3 style="color:lightgreen;text-align:center;">Total Available Book(s) : <?php echo $num ?></h3><br/>
		...
		<table class="table table-bordered table-hover table-responsive">
			...
			<tbody id="myTable">
				...
				<tr>
					...
					<td><input type="checkbox" value="<?php echo $row['b_id']?>" name="b<?php echo $row['b_id']?>"/></td>
				</tr>
				<?php
					}
				?>
			...
			<tbody>
	  <tr>
	    <td colspan="5" ><input class="btn btn-primary" type="submit" value="Issue Book(s)" /></td>
	  </tr>
	</tbody>
	</table></form>
