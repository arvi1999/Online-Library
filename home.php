...
<html>
  ...
  <div class="container-fluid"><br/><br/>
    <div class="jumbotron"><h1 align="center"><img src="photos\Online-Library.jpg" style="width:100px;height;100px;"/> Online-Library</h1></div></div>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:lavender;">
	  ...
	  <li class="active"><a href="home.php"><i class="material-icons" style="font-size:15.5px">home</i>Home</a></li>
