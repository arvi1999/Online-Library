...
<html>
    ...
    <body>
        ...
        <div class="jumbotron"><br/><br/><h1 align="center"><img src="Online-Library.jpg" style="width:100px;height;100px;"/> Online-Library</h1></div>
        <h3 style="color:lightgreen;text-align:center;">You have Issued <?php echo $num ?> Book(s) !</h3><br/>
        ...
        <table class="table table-bordered table-hover table-responsive">
            ...
            <tbody>
                <tr>
                    <td colspan="5" ><input class="btn btn-primary" type="submit" value="Return Book(s)" /></td>
                </tr>
            </tbody>
        </table>
      </form>
